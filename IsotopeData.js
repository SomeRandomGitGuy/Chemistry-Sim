const isotopes = {
  ...
  K: { decay: "beta-", neutrons: 21, halfLife: 1248000000 },
...
const data = [
  ...
  { symbol: "Cs", shells: [2, 8, 18, 18, 8, 1], neut: 78, electronegativity: 0.79, section: "Alkali metals" },
  ...
  { symbol: "Pa", shells: [2, 8, 18, 32, 20, 9, 2], neut: 140, electronegativity: 1.5, section: "Actinides" },
  { symbol: "U", shells: [2, 8, 18, 32, 21, 9, 2], neut: 146, electronegativity: 1.38, section: "Actinides" },
  { symbol: "Np", shells: [2, 8, 18, 32, 22, 9, 2], neut: 143, electronegativity: 1.36, section: "Actinides" },
  { symbol: "Pu", shells: [2, 8, 18, 32, 24, 8, 2], neut: 144, electronegativity: 1.28, section: "Actinides" },
  { symbol: "Am", shells: [2, 8, 18, 32, 25, 8, 2], neut: 150, electronegativity: 1.13, section: "Actinides" },
  { symbol: "Cm", shells: [2, 8, 18, 32, 25, 9, 2], neut: 151, electronegativity: 1.3, section: "Actinides" },
  { symbol: "Bk", shells: [2, 8, 18, 32, 27, 8, 2], neut: 142, electronegativity: 1.3, section: "Actinides" },
  { symbol: "Cf", shells: [2, 8, 18, 32, 28, 8, 2], neut: 145, electronegativity: 1.3, section: "Actinides" },
  { symbol: "Es", shells: [2, 8, 18, 32, 29, 8, 2], neut: 151, electronegativity: 1.3, section: "Actinides" },
  { symbol: "Fm", shells: [2, 8, 18, 32, 30, 8, 2], neut: 157, electronegativity: 1.3, section: "Actinides" },
  { symbol: "Md", shells: [2, 8, 18, 32, 31, 8, 2], neut: 158, electronegativity: 1.3, section: "Actinides" },
  { symbol: "No", shells: [2, 8, 18, 32, 30, 8, 2], neut: 159, electronegativity: 1.3, section: "Actinides" },
  { symbol: "Lr", shells: [2, 8, 18, 32, 32, 8, 3], neut: 162, electronegativity: 1.3, section: "Actinides" },
  { symbol: "Rf", shells: [2, 8, 18, 32, 32, 10, 2], neut: 164, electronegativity: 1.3, section: "Transition metals" },
  { symbol: "Db", shells: [2, 8, 18, 32, 32, 11, 2], neut: 168, electronegativity: 1.3, section: "Transition metals" },
  { symbol: "Sg", shells: [2, 8, 18, 32, 32, 12, 2], neut: 173, electronegativity: 1.3, section: "Transition metals" },
  { symbol: "Bh", shells: [2, 8, 18, 32, 32, 13, 2], neut: 174, electronegativity: 1.3, section: "Transition metals" },
  { symbol: "Hs", shells: [2, 8, 18, 32, 32, 14, 2], neut: 177, electronegativity: 1.3, section: "Transition metals" },
  { symbol: "Mt", shells: [2, 8, 18, 32, 32, 15, 2], neut: 178, electronegativity: 1.3, section: "Unknown" },
  { symbol: "Ds", shells: [2, 8, 18, 32, 32, 16, 2], neut: 181, electronegativity: 1.3, section: "Unknown" },
  { symbol: "Rg", shells: [2, 8, 18, 32, 32, 17, 2], neut: 183, electronegativity: 1.3, section: "Unknown" },
  { symbol: "Cn", shells: [2, 8, 18, 32, 32, 18, 2], neut: 185, electronegativity: 1.3, section: "Unknown" },
  { symbol: "Nh", shells: [2, 8, 18, 32, 32, 18, 3], neut: 187, electronegativity: 1.3, section: "Unknown" },
  { symbol: "Fl", shells: [2, 8, 18, 32, 32, 18, 4], neut: 190, electronegativity: 1.3, section: "Unknown" },
  { symbol: "Mc", shells: [2, 8, 18, 32, 32, 18, 5], neut: 193, electronegativity: 1.3, section: "Unknown" },
  { symbol: "Lv", shells: [2, 8, 18, 32, 32, 18, 6], neut: 195, electronegativity: 1.3, section: "Unknown" },
  { symbol: "Ts", shells: [2, 8, 18, 32, 32, 18, 7], neut: 197, electronegativity: 2.2, section: "Unknown" },
  { symbol: "Og", shells: [2, 8, 18, 32, 32, 18, 8], neut: 200, electronegativity: 2.0, section: "Unknown" },
  /* THEORETICAL ELEMENTS, i made up the defualt isotopes */
  { symbol: "Uue", shells: [2, 8, 18, 32, 32, 18, 8, 1], neut: 203, electronegativity: 0.86, section: "Alkali metals" },
  { symbol: "Ubn", shells: [2, 8, 18, 32, 32, 18, 8, 2], neut: 206, electronegativity: 0.91, section: "Unknown" },
];
